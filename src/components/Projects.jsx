        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            <div 
              ...
              className="bg-[#121214] text-white rounded-3xl overflow-hidden border border-zinc-800/80 flex flex-col justify-between hover:shadow-xl transition-all duration-300 group hover:-translate-y-1 cursor-pointer"
            >
              <div>
                {/* Project Cover Image */}
