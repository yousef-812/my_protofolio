  ...
  return (
    <section id="home" className="pt-24 pb-12 px-6 bg-[#F4F4F6] text-[#1E1E1E] flex flex-col items-center">
      <div className="max-w-4xl w-full">
        ...
        <div className="relative w-full h-[400px] md:h-[500px] bg-[#E4E4E6] rounded-3xl overflow-hidden border border-zinc-300/50 shadow-sm flex flex-col justify-between p-5 md:p-8">
          ...
          <div className="flex justify-between items-start z-10 w-full">
            ...
            <p className="text-[9px] md:text-xs text-zinc-500 max-w-[170px] md:max-w-[280px] text-right leading-relaxed font-medium">
          ...
          <div className="absolute inset-0 flex items-center justify-center z-0 select-none pointer-events-none px-4">
            <h1 className="text-[38px] xs:text-[48px] sm:text-[80px] md:text-[100px] lg:text-[110px] font-black text-white/85 tracking-tighter leading-none text-center uppercase font-display">
              Web<br />Developer
            </h1>
          </div>
          ...
          <div className="absolute inset-0 flex items-center justify-center z-5 pointer-events-none">
            <div className="w-[170px] h-[170px] xs:w-[190px] xs:h-[190px] md:w-[320px] md:h-[320px] flex items-center justify-center">
              <img 
                src={avatarUrl} 
                alt="Yousef Yousry" 
          ...
          {/* Right Floating Arrow Button - Hidden on very small mobile */}
          <div className="absolute right-4 md:right-10 top-1/2 -translate-y-1/2 z-10 hidden xs:block">
            <a 
              href="#projects" 
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8 text-left text-sm md:text-base leading-relaxed">
          ...
          <div className="flex flex-col justify-between h-full pl-0 md:pl-6 gap-4">
            <p className="text-zinc-550 font-medium text-xs md:text-sm">
            ...
            <a 
              ...
              className="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-zinc-900 border-b border-zinc-900 pb-0.5 w-fit hover:text-indigo-600 hover:border-indigo-600 transition-all duration-200"
            >
              More about me 
              <span>→</span>
            </a>
